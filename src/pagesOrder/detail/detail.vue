...
// 获取订单详情
const order = ref<OrderResult>() || ref({})
  ...
  <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrollToLower">
    <template v-if="true">
      ...
      <view class="shipment">
        <!-- 用户收货地址 -->
        <view class="locate">
          <view class="user"> {{ order!.receiverAddress }}</view>
          <view class="phone"> {{ order!.receiverMobile }}</view>
          <view class="address"> {{ order!.receiverContact }} </view>
        </view>
      </view>
